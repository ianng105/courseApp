...
public class UserController {
    ...
    public String profile(Principal principal, Model model) {
        Users user = us.findByUsername(principal.getName());
        model.addAttribute("user", user);
        return "profile";
    }

    @PostMapping("/profile/update")
    public String updateProfile(@ModelAttribute Users user, Principal principal) {
        us.updateUser(principal.getName(), user);
